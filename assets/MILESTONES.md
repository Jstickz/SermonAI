...
|---|---|---|---|---|---|
| M0 | Foundation & Lightweight Installer | 0 | 8 Sept – 21 Sept 2026 | ⬜ Not started | |
...
**Deliverables**
- [ ] Repo created with the structure in PRD §10.7. `README.md`, `docs/PRD.md`, `docs/MILESTONES.md` committed.
- [ ] Tauri 2 project scaffolded: React + TypeScript + Tailwind + Zustand frontend, Rust backend, Vite dev server working.
- [ ] Three windows (operator, projector, alternate) created from Rust and placed on chosen monitors using the monitor API. Projector window is frameless and fullscreen.
...
- [ ] SQLite schema from PRD §14.2 created via migrations on first launch.
- [ ] ADRs written: Tauri over Electron; staging-first output; three-stage detection; local-only data; summary JSON schema; packs strategy.
